...
## Fortinet Single Sign-On (FSSO) Mechanism
...
Stay tuned for our first post where we’ll kick off with designing your network topology using GNS3 and VMware and configure baseline routing and policies.